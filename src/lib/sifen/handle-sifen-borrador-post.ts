 ...
 *
 * Extraído del route `POST /api/facturas/[id]/sifen/borrador` sin cambios de
 * comportamiento: `POST /sifen/encolar` lo reutiliza para asegurar el DE antes
 * de insertar el Job, sin pegarle por HTTP a su propia API.
 */
